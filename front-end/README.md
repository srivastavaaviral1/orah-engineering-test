...
![Sort students](./project-ss/sort.png)

### Search Students

![Search students](./project-ss/search.png)

### Count Students

![Student attendance](./project-ss/count.png)

### Activity Page

![Activity page](./project-ss/activity-page.png)
